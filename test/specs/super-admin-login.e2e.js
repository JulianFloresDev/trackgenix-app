...
describe('The super-admin should log in.', () => {
  ...
  it('Login successfully', async () => {
    ...
    await expect(HomePageLogged.namePersonLogged).toHaveTextContaining('Ana Ibaceta');
    await HomePageLogged.entityLogged.waitForDisplayed({ timeout: 2000 });
    await expect(HomePageLogged.entityLogged).toHaveTextContaining('Super-Admin');
