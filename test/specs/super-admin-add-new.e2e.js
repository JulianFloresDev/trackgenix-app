...
describe('Add new Admin', () => {
    ...
    it('should added admin successfully', async () => {
       ...
       await FormPage.createAdmin('Test', 'Automation', 'algo@alguiyot.com', 'Abcd1234', '47112225', '77547774', 'Lugar 1234');
    ...
    it('should edited admin successfully', async () => {
        ...
        await FormPage.editAdmin('Testeado', 'Juan', 'algo@alguien.com', '47112225', '77547774', 'Lugar 1234');
