...
describe('Add new Admin', () => {
    beforeAll('Navigate URL', () => {
        browser.url('https://alfon-a-trackgenix-btjyyqz4g-basp-a2022.vercel.app/home');
    });

    it('should added admin successfully', async () => {
       await LoginPage.loginButton.click();
       await expect(browser).toHaveUrl('https://alfon-a-trackgenix-btjyyqz4g-basp-a2022.vercel.app/auth/login');
       await LoginPage.login('ana@super-admin.com', '12345superadmin')
       await expect(browser).toHaveUrl('https://alfon-a-trackgenix-btjyyqz4g-basp-a2022.vercel.app/super-admins');
